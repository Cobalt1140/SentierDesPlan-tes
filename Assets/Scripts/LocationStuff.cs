...
public class LocationStuff : MonoBehaviour
{
    ...
    {
        { "French", new string[] { "Le Soleil", "Mercure", "Venus", "La Terre", "Mars", "Jupiter", "Saturne", "Uranus", "Neptune", "Sélectionner"} },
        { "English", new string[] { "The Sun", "Mercury", "Venus", "The Earth", "Mars", "Jupiter", "Saturn", "Uranus", "Neptune", "Select"} },
    ...
    private void InitializeDropdown()
    {
        ...
        string neutral = "Select";
        if (translations.ContainsKey(language))
        {
            neutral = translations[language][9];

        }
        // Ajouter une option "Sélectionner une planète" en premier
        options.Add(new TMP_Dropdown.OptionData(neutral));
